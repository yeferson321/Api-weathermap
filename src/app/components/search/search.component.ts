...
export class SearchComponent implements OnInit {
  ...
  /* The onSubmit function is called when the form is submitted. If the form is valid, the weatherservice.getDirectGeocoding
  function is called and the data from the observable is passed into the validateSearch function. If there is an error, 
  the error variable is set to the error message */
  onSubmit = (): void => {
    if (this.form.valid) {
